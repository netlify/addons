...
```
GET     /               # returns the manifest for the API (in dev - not required yet)
...
1. The request from Netlify to your service occurs
    ...
    ```js
    {
      ...
      config: {
        ...
        controller: 'api/v1/service_instances',
        action: 'create',
        // Netlify Site id
...
For now, you can register your add-on namespace/endpoint by [filling out this form](https://new-cli.netlify.com/register-addon) and we will get you set up in Netlify's add-on marketplace.
